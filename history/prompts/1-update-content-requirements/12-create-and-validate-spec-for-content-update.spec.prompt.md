...
- 🧠 Reflection: PowerShell's `grep` and `Rename-Item` commands have different syntax and behavior compared to their Linux counterparts, requiring adjustments in command usage.
